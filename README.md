...
🌱 Currently learning **C#, ASP.NET Core, Entity Framework Core, SQL Server**.

⚡ Strong foundation in **C++, OOP, Data Structures & Algorithms**.

🌐 Experienced with **HTML, CSS, JavaScript, and Bootstrap**.

🤖 Interested in integrating **Artificial Intelligence** into future software applications.
